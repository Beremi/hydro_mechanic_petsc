...
ViewHDF5.createHDF5('grid2.h5', mode=PETSc.Viewer.Mode.WRITE,comm= PETSc.COMM_WORLD)
ViewHDF5.view(obj=myVector)   # Put PETSc object into the viewer
#ViewHDF5.destroy()            # Destroy Viewer
#
## Load *.h5 file
#ViewHDF5 = PETSc.Viewer()     # Init. Viewer
#ViewHDF5.createHDF5('grid1.h5', mode=PETSc.Viewer.Mode.READ,comm= PETSc.COMM_WORLD)
#ViewHDF5.view(obj=myVector)   # Put PETSc object into the viewer
#ViewHDF5.destroy()            # Destroy Viewer
#
#
